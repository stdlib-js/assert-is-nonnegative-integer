...
bench( pkg+'::primitives', function benchmark( b ) {
	...
	for ( i = 0; i < b.iterations; i++ ) {
		bool = isNonNegativeInteger( values[ i % values.length ] );
		if ( !isBoolean( bool ) ) {
...
bench( pkg+'::primitives:isPrimitive', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		bool = isNonNegativeInteger.isPrimitive( values[ i % values.length ] );
		if ( !isBoolean( bool ) ) {
			b.fail( 'should return a boolean' );
		}
	}
...
bench( pkg+'::primitives:isObject', function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		bool = isNonNegativeInteger.isObject( values[ i % values.length ] );
		if ( !isBoolean( bool ) ) {
			b.fail( 'should return a boolean' );
		}
	}
